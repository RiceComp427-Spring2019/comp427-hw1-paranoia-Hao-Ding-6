...
- Countermeasures:
  ...
  - Then I should prevent my computer from any physical damage For example, I can buy a laptop cover to protect it from dropping or hitting. I can buy a keyboard membrane to defend the water. And I can add a eletronic tracker on my computer so that even if it was stolen by thieves, I can also find it according to the tracker's signal. This measure would cost lots of money but I think it is neccesary, because I am protecting my computer and my data which is much more valuable than that cost.
